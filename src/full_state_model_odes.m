function [ oderhs ] = full_state_model_odes(dim, gridsz, c_ma, c_prop, mu,kb, ...
...
if dim>1
    ...
    for ii=2:dim-1
        ...
        W(ii,ii-1) = -eps_prop; %nonlocal, anterior term is weak, negative
    end
    W(dim,dim-1) = -eps_prop;%nonlocal, anterior term is weak, negative
