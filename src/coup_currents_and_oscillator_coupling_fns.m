function [ H_m, H_p, H_g, C_m, C_p, C_n ] = coup_currents_and_oscillator_coupling_fns( X, Z ,dt,period)
%Coupled oscillator model coupling currents and functions:
...
%       C_m - coupling current for mechanical coupling (K')
%       C_p - coupling current for proprioceptive coupling (K)
%       C_n - coupling current for electrical coupling (V)
