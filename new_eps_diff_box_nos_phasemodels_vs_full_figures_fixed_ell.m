% ==================================================================
%
%                     new_eps_diff_box_nos_phasemodels_vs_full_figures_fixed_ell.m
%                      ------- 
...
%2 boxes
load('Nbox_phasediffs/new_eps/2box_phase_vs_full_gamma_loop_data_neweps.mat');
fig=figure(2); clf;
colors = colorblind([1],:,:);
...
saveas(fig,'figs/Nbox_phasediffs/new_eps/2box_phasediffs_new_eps.png');
...
%3 boxes
load('Nbox_phasediffs/new_eps/3box_phase_vs_full_gamma_loop_data_neweps.mat');
fig=figure(3); clf;
...
saveas(fig,'figs/Nbox_phasediffs/new_eps/3box_phasediffs_new_eps.png');
...
%4 boxes
load('Nbox_phasediffs/new_eps/4box_phase_vs_full_gamma_loop_data_neweps.mat');
fig=figure(4); clf;
...
saveas(fig,'figs/Nbox_phasediffs/new_eps/4box_phasediffs_new_eps.png');
...
%5 boxes
load('Nbox_phasediffs/new_eps/5box_phase_vs_full_gamma_loop_data_neweps.mat');
fig=figure(5); clf;
...
saveas(fig,'figs/Nbox_phasediffs/new_eps/5box_phasediffs_new_eps.png');
...
%6 boxes
load('Nbox_phasediffs/new_eps/6box_phase_vs_full_gamma_loop_data_neweps.mat');
fig=figure(6); clf;
...
saveas(fig,'figs/Nbox_phasediffs/new_eps/6box_phasediffs_new_eps.png');
...
%10 boxes
load('Nbox_phasediffs/new_eps/10box_phase_vs_full_gamma_loop_data_neweps.mat');
fig=figure(10); clf;
...
saveas(fig,'figs/Nbox_phasediffs/new_eps/10box_phasediffs_new_eps.png');
...
%12 boxes
load('Nbox_phasediffs/new_eps/12box_phase_vs_full_gamma_loop_data_neweps.mat');
fig=figure(12); clf;
...
saveas(fig,'figs/Nbox_phasediffs/new_eps/12box_phasediffs_new_eps.png');
...
%20 boxes
load('Nbox_phasediffs/new_eps/20box_phase_vs_full_gamma_loop_data_neweps.mat');
fig=figure(20); clf;
colors = linspecer(19);
h = semilogx(little_gamma,mod(phase_model_eq2,1),'o-','LineWidth',2,'MarkerSize',10); hold on;
set(h, {'color'}, num2cell(colors,2));
...
saveas(fig,'figs/Nbox_phasediffs/new_eps/20box_phasediffs_new_eps.png');
...
%25 boxes
load('Nbox_phasediffs/new_eps/25box_phase_vs_full_gamma_loop_data_neweps.mat');
fig=figure(25); clf;
colors = linspecer(24);
h = semilogx(little_gamma,mod(phase_model_eq2,1),'o-','LineWidth',2,'MarkerSize',10); hold on;
set(h, {'color'}, num2cell(colors,2));
...
saveas(fig,'figs/Nbox_phasediffs/new_eps/25box_phasediffs_new_eps.png');
